...
- **О компании**: 3-6 предложений - чем занимается (отталкивайся от
  официального PKD из задачи и сайта компании), какие продукты/услуги,
  для кого работает, масштаб; затем 2-4 свежие новости или публичных
  события с датами и ссылками (расширение, награды, суды, увольнения -
  что нашлось). Нет новостей - так и напиши, это нормально для малых
  компаний. Не пересказывай финансы здесь - для них своя секция
