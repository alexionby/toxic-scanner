...
ликвидация/банкротство - как есть из задачи
## Краткий вывод
2-4 предложения
...
## Отзывы сотрудников
повторяющиеся жалобы и плюсы с GoWork/Reddit со ссылками, с пометкой
"неофициальный сигнал"; если отзывов не нашлось - явно скажи об этом
## Риск-флаги
список
## Качество данных
